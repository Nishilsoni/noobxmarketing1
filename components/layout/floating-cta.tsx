  ...
  return (
    <>
      ...
      <motion.a
        ...
        className={cn(
          "group fixed right-5 z-40 inline-flex size-14 items-center justify-center rounded-full bg-[#00fff0] text-space-950 shadow-[0_10px_30px_-6px_rgba(0,255,240,0.6)] transition-all hover:scale-105",
          barVisible ? "bottom-24 sm:bottom-6" : "bottom-6",
        )}
      >
        {!reduce && (
          <span className="absolute inset-0 animate-ping rounded-full bg-[#00fff0] opacity-30 [animation-duration:2.5s]" />
        )}
