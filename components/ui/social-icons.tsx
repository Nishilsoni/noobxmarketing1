...
export function DribbbleIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm7.93 5.53a10.16 10.16 0 0 1 2.3 6.36c-.34-.07-3.7-.75-7.08-.33-.07-.17-.14-.34-.22-.52-.21-.49-.43-.97-.67-1.44 3.74-1.53 5.44-3.73 5.67-4.07zM12 1.78c2.6 0 4.98.98 6.78 2.58-.19.27-1.72 2.33-5.33 3.7A52.4 52.4 0 0 0 9.6 2.13 10.3 10.3 0 0 1 12 1.78zM7.63 2.83a61.6 61.6 0 0 1 3.82 5.85c-4.83 1.28-9.09 1.26-9.55 1.26a10.26 10.26 0 0 1 5.73-7.11zM1.78 12.02v-.31c.44.01 5.45.07 10.6-1.47.3.58.58 1.17.83 1.76l-.4.12c-5.32 1.72-8.15 6.41-8.39 6.81a10.2 10.2 0 0 1-2.64-6.91zm10.22 10.2c-2.3 0-4.43-.77-6.13-2.07.19-.39 2.3-4.46 8.12-6.49l.07-.02a42.6 42.6 0 0 1 2.19 7.78 10.16 10.16 0 0 1-4.25.8zm5.98-1.75a44 44 0 0 0-2-7.34c3.18-.51 5.96.32 6.31.43a10.2 10.2 0 0 1-4.31 6.91z" />
    </svg>
  );
}
